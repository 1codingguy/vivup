...
- sort the country by name, then assign to `countriesData` variable
  - I could use a.localCompare(b), which I previously forgot until searching for how to sort alphabet with accents
...
Use dev-tool to copy the styling from other fields, apply to dropdown menu
